...
routes_2023 <- read_excel("Desktop/PMC Github/RiderReg23/Jarrett_StatsbyRouteStart.xlsx", 
...
write_xlsx(final_table,"Desktop/PMC Github/RiderReg23/StatsBySimplifiedRoute2023.xlsx" )
